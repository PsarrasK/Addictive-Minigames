...
function init(b) {
	...
	if (b) {
		$("#pauseBtn").attr('src',"https://dl.dropbox.com/s/v0e3btxr74klfkv/btn_pause.svg");
...
function showHelp() {
	if ($('#openSideBar').attr('src') == 'https://dl.dropbox.com/s/p59wyozcxlypskf/btn_back.svg') {
		$('#openSideBar').attr('src', 'https://dl.dropbox.com/s/hd5dfurtpt98hbs/btn_help.svg');
		if (gameState != 0 && gameState != -1 && gameState != 2) {
			$('#fork-ribbon').fadeOut(150, 'linear');
		}
	} else {
		$('#openSideBar').attr('src', 'https://dl.dropbox.com/s/p59wyozcxlypskf/btn_back.svg');
		if (gameState == 0 && gameState == -1 && gameState == 2) {
	...
	if($("#pauseBtn").attr('src') == "https://dl.dropbox.com/s/v0e3btxr74klfkv/btn_pause.svg" && gameState != 0 && !infobuttonfading) {
		return;
	}
